<template>
  <section class="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-blue-500 to-indigo-600 text-white">
    <h1 class="text-4xl font-bold mb-8">Weather App</h1>
    <div class="flex flex-col">
    <!-- Formulario -->
    <form @submit.prevent="getWeather" class="flex flex-row max-w-md items-center gap-6 bg-white text-gray-800 p-6 rounded-lg shadow-lg">
      ...
      <button type="submit" class="bg-blue-600 text-white text-sm font-bold px-4 py-2 rounded-md hover:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-500">
        Get Weather
      </button>
    </form>
    ...
    <div v-else-if="weather" class="mt-6 p-6 bg-white text-gray-800 rounded-lg shadow-lg w-full max-w-md flex flex-col items-center">
...
export default {
  ...
  methods: {
    async getWeather() {
      ...
      this.error = "";
      this.weather = null;
      const apiKey = "d36a501f801e7b079cd2dd0bea004d50";
